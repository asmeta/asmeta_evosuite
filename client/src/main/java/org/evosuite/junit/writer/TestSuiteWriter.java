...
public class TestSuiteWriter implements Opcodes {
    ...
    private void writeAsmetaChoiceTrace(String outputDirectory, List<ExecutionResult> results) {
        ...
        try {
            ...
            java.util.Properties traceProperties = new OrderedProperties();
            ...
            try (FileOutputStream outputStream = new FileOutputStream(traceFile)) {
                traceProperties.store(outputStream, "ASMETA choose rules trace generated by EvoSuite");
            }
        } catch (IOException e) {
    ...
    /** Properties implementation whose iteration order matches insertion order. */
    private static final class OrderedProperties extends java.util.Properties {

        private static final long serialVersionUID = 1L;
        private final List<Object> orderedKeys = new ArrayList<>();
        ...
        public synchronized Enumeration<Object> keys() {
            return Collections.enumeration(new ArrayList<>(orderedKeys));
        }
